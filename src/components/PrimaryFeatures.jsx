...
import screenshotExpenses from '@/images/screenshots/1.png'
import screenshotPayroll from '@/images/screenshots/2.png'
import screenshotReporting from '@/images/screenshots/3.png'
import screenshotVatReturns from '@/images/screenshots/2.png'

const features = [
  {
    title: 'Hard Drilling',
    description:
      "Before you join us, we will drill you!",
    image: screenshotExpenses,
  },
  {
    title: 'Earn Big Buck',
    description:
      "When you become a Pigeon, Trust you will work on a sea of project",
  ...
  },
  {
    title: 'No Interview',
    description:
      'Get Employed without Interview',
